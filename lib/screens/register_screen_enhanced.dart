          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                ).animate().slideY(duration: 600.ms, delay: 100.ms),
                ...
                ).animate().slideY(duration: 700.ms, delay: 100.ms),
                  ...
                  child: Column(
                    children: [
                      ...
                      TextFormField(
                          ...
                          .animate()
                          .slideY(duration: 600.ms, delay: 150.ms)
                      ...
                      TextFormField(
                          ...
                          .animate()
                          .slideY(duration: 600.ms, delay: 250.ms)
                          .fadeIn(duration: 600.ms),
                      const SizedBox(height: 16),
                      // Password field
                      Consumer<AuthProvider>(
                          ...
                          .animate()
                          .slideY(duration: 600.ms, delay: 350.ms)
                          .fadeIn(duration: 600.ms),
                      const SizedBox(height: 8),
                      Text(
                      ...
                      TextFormField(
                          ...
                          .animate()
                          .slideY(duration: 600.ms, delay: 400.ms)
                          .fadeIn(duration: 600.ms),
                      ...
                      ).animate().slideY(duration: 600.ms, delay: 500.ms),
                      const SizedBox(height: 24),
                      // Register button
                      Consumer<AuthProvider>(
                            builder: (context, authProvider, _) {
                ...
                Row(
                    ...
                    .animate()
                    .slideY(duration: 600.ms, delay: 600.ms)
                    .fadeIn(duration: 600.ms),
              ],
            ),
          ),
